...
void main() {
  group('Forth: parsing and numbers - ', () {
  ...
  group('Forth: combined arithmetic - ', () {
  ...
  group('Forth: user-defined words - ', () {
  ...
  group('Forth: case-insensitivity - ', () {
